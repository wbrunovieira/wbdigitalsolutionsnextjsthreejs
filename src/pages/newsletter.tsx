...
const content = {
  "pt-BR": {
    ...
    successMsg: "Confirme seu e-mail e nos vemos em breve na sua caixa de entrada.",
  ...
  en: {
    ...
    successMsg: "Confirm your email and we'll see you soon in your inbox.",
  ...
  es: {
    ...
    successMsg: "Confirma tu correo y nos vemos pronto en tu bandeja de entrada.",
  ...
  it: {
    ...
    successMsg: "Conferma la tua email e ci vediamo presto nella tua casella.",
