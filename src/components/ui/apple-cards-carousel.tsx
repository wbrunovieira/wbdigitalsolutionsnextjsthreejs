    ...
    >
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2 mr-10">
          ...
          >
            <IconArrowNarrowLeft aria-hidden="true" className="h-6 w-6 text-gray-500" />
          </button>
          <button
            type="button"
            aria-label="Próximo"
          ...
          >
            <IconArrowNarrowRight aria-hidden="true" className="h-6 w-6 text-gray-500" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
          ...
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              ...
              <motion.p
                ...
                className="text-2xl md:text-5xl font-semibold text-primary"
              >
                {card.title}
              </motion.p>
