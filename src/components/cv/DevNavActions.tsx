...
import { BurgerLines } from './DevNavMobile';
...
/** WhatsApp CTA + language switcher + burger button. DEV CV only. */
const DevNavActions: React.FC<DevNavActionsProps> = ({
  lang, setLanguage, menuOpen, openLabel, onOpenMenu,
}) => (
  <div className="flex items-center gap-3">
    {/* Header CTA goes straight to WhatsApp: inverted pill (white on the dark
        theme) + the green lives only in the icon. */}
    <a
