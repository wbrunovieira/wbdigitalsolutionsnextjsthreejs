...
/**
 * One entry of the sales timeline (extracted from SalesTimeline): the node
 * that lights up crossing the viewport center (reading cursor), the year/age
 * header, role/location line and bullets, plus the md+ outlined year
 * watermark drifting at a different speed for depth. Also home of the
...
import type { TimelineEntry } from "@/content/salesTimeline";
import { AMBER, BG_B, INK, ink } from "./salesTheme";
...
const SalesTimelineItem: React.FC<{ e: TimelineEntry; index: number; showWatermark: boolean }> = ({
  e,
  index,
  showWatermark,
}) => {
