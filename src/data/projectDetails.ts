...
const kundalini: Record<string, ProjectDetailContent> = {
  'pt-BR': {
    ...
    features: [
      ...
      { icon: '🛠️', title: 'Painel da cliente (CMS)', description: 'A própria cliente atualiza fotos, vídeos, depoimentos, sessões, locais e textos do site — sem depender de programador.' },
    ],
    highlightsTitle: 'Destaques de construção',
    highlights: [
      'CMS próprio: a cliente edita o site sozinha por um painel protegido por login.',
      'Upload de imagens com compressão e conversão de HEIC no navegador (Vercel Blob).',
      'Vídeos via Mux (upload e streaming) e reordenação drag-and-drop das galerias.',
      'Landing focada em conversão, animações GSAP + Framer Motion, rápida e pronta para SEO.',
    ],
    stats: [
  ...
  en: {
    ...
    features: [
      ...
      { icon: '🛠️', title: 'Client CMS', description: 'The client updates photos, videos, testimonials, sessions, locations and text herself — no developer needed.' },
    ],
    highlightsTitle: 'Build highlights',
    highlights: [
      'Custom CMS: the client edits the whole site herself from a login-protected panel.',
      'Image upload with in-browser compression and HEIC conversion (Vercel Blob).',
      'Video via Mux (upload and streaming) and drag-and-drop gallery reordering.',
      'Conversion-focused landing, GSAP + Framer Motion animations, fast and SEO-ready.',
    ],
    stats: [
  ...
  es: {
    ...
    features: [
      ...
      { icon: '🛠️', title: 'Panel de la clienta (CMS)', description: 'La propia clienta actualiza fotos, vídeos, testimonios, sesiones, lugares y textos del sitio — sin depender de un programador.' },
    ],
    highlightsTitle: 'Aspectos destacados',
    highlights: [
      'CMS propio: la clienta edita el sitio sola desde un panel protegido por login.',
      'Subida de imágenes con compresión y conversión de HEIC en el navegador (Vercel Blob).',
      'Vídeos vía Mux (subida y streaming) y reordenación drag-and-drop de las galerías.',
      'Landing enfocada en conversión, animaciones GSAP + Framer Motion, rápida y lista para SEO.',
    ],
    stats: [
  ...
  it: {
    ...
    features: [
      ...
      { icon: '🛠️', title: 'Pannello della cliente (CMS)', description: 'La cliente aggiorna da sola foto, video, testimonianze, sessioni, luoghi e testi del sito — senza bisogno di uno sviluppatore.' },
    ],
    highlightsTitle: 'Punti salienti',
    highlights: [
      'CMS proprio: la cliente modifica il sito da sola da un pannello protetto da login.',
      'Upload immagini con compressione e conversione HEIC nel browser (Vercel Blob).',
      'Video via Mux (upload e streaming) e riordino drag-and-drop delle gallerie.',
      'Landing orientata alla conversione, animazioni GSAP + Framer Motion, veloce e pronta per la SEO.',
    ],
    stats: [
