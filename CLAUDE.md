...
**Critical**: When adding translatable text, update ALL 4 locale files.
...
`next.config.js` defines Content Security Policy. When adding external scripts/APIs, update the CSP allowlist.
